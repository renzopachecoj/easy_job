...
const CARD_TITLE_STYLE = TextStyle(
    color: Color(0xff40B491), fontSize: 20.0, fontWeight: FontWeight.w500);
...
const CARD_BUTTON_TEXT_STYLE = TextStyle(
    color: Color(0xff40B491), fontSize: 16.0, fontWeight: FontWeight.w500);
      ...
      child: MaterialApp(
        ...
        home: Scaffold(
            ...
            body: Center(
              ...
              _isLoading
                  ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color(0xff40B491)),))
                  : Expanded(
                      child: Padding(
                        padding: EdgeInsets.all(PADDING),
